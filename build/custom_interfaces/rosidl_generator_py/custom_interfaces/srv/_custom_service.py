...
class Metaclass_CustomService(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'custom_interfaces.srv.CustomService')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from custom_interfaces.srv import _custom_service
...
class CustomService(metaclass=Metaclass_CustomService):
    from custom_interfaces.srv._custom_service import CustomService_Request as Request
    from custom_interfaces.srv._custom_service import CustomService_Response as Response
