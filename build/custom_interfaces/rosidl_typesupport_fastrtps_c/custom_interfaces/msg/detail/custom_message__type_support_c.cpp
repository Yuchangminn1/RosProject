...
#include "custom_interfaces/msg/detail/custom_message__rosidl_typesupport_fastrtps_c.h"
...
using _CustomMessage__ros_msg_type = custom_interfaces__msg__CustomMessage;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: cmd_linear_vel
  {
    cdr << ros_message->cmd_linear_vel;
  }

  // Field name: cmd_angular_vel
  {
    cdr << ros_message->cmd_angular_vel;
  }
...
size_t get_serialized_size_custom_interfaces__msg__CustomMessage(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  ...
  // field.name cmd_linear_vel
  {
    size_t item_size = sizeof(ros_message->cmd_linear_vel);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name cmd_angular_vel
  {
    size_t item_size = sizeof(ros_message->cmd_angular_vel);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name x
...
static uint32_t _CustomMessage__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_interfaces__msg__CustomMessage(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces
size_t max_serialized_size_custom_interfaces__msg__CustomMessage(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_interfaces__msg__CustomMessage;
    is_plain =
      (
      offsetof(DataType, y) +
      last_member_size
...
static size_t _CustomMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_interfaces__msg__CustomMessage(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interfaces, msg, CustomMessage)() {
